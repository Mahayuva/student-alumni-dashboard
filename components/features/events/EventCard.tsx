        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow group overflow-hidden flex flex-col h-full">
            <div className="h-32 bg-gradient-to-r from-indigo-500 to-purple-500 relative">
                <div className="absolute top-4 right-4">
                    <Badge className="bg-white/90 text-indigo-700 hover:bg-white">{event.type}</Badge>
                </div>
            ...
            <div className="pt-8 px-6 pb-6 flex-1 flex flex-col">
                ...
                {isAlumniView ? (
                    <button className="w-full py-2.5 bg-slate-50 text-slate-600 rounded-lg text-sm font-bold hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                        Manage Event
                    </button>
                ) : (
                    <button
                        ...
                        className="w-full py-2.5 bg-indigo-600 text-white rounded-lg text-sm font-bold hover:bg-indigo-700 transition-colors"
                    >
                        Register Now
                    </button>
                )}
