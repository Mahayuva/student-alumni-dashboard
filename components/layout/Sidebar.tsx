    ...
    return (
        <aside className="w-[272px] bg-white/50 border-r border-white/30 h-screen flex flex-col fixed left-0 top-0 z-30 backdrop-blur-xl">
            <div className="p-4 pb-1">
                <h1 className="text-xl font-bold flex items-center gap-3 mb-2">
                    <div className="w-9 h-9 bg-primary rounded-xl flex items-center justify-center text-white shrink-0 shadow-lg shadow-black/10">
                ...
                {items.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            href={item.href}
                            className={cn(
                                "flex items-center gap-3 px-4 py-2.5 rounded-2xl transition-all duration-300 group text-sm font-medium",
                                isActive
                        ...
                        >
                            <item.icon className={cn("w-4 h-4 transition-colors", isActive ? "text-slate-900 fill-slate-900/10" : "text-slate-400 group-hover:text-slate-600")} />
