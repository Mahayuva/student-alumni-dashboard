    ...
    return (
        <aside className="w-[272px] bg-white/50 border-r border-white/30 h-screen flex flex-col fixed left-0 top-0 z-30 backdrop-blur-xl">
            <div className="p-6 pb-2">
                <h1 className="text-xl font-bold flex items-center gap-3 mb-4">
                ...
                {items.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            href={item.href}
                            className={cn(
                                "flex items-center gap-4 px-5 py-2.5 rounded-2xl transition-all duration-300 group text-sm font-medium",
                                isActive
